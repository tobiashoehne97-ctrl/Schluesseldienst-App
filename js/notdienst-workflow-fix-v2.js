...
(function(){
  ...
  window.ndContinueToClose=function(id){
    ...
    const old=read('schluesseldienst-notdienst-abrechnung-v2',{});
    const d=old[id]||{};
    ...
    old[id]=d;write('schluesseldienst-notdienst-abrechnung-v2',old);
    write(KEY,{...read(KEY,{}),[id]:t});
